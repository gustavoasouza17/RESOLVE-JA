...
const mockProposals: MockProposal[] = [
  ...
  // ─── Propostas adicionais para client001 (histórico mais rico) ────────────────
  {
    id: 'prop006',
    clienteId: 'client001',
    prestadorId: 'prof003',
    descricao: 'Instalação de fiação elétrica e tomadas novas na cozinha.',
    endereco: 'Rua das Flores, 123 — Jardim São Paulo',
    dataDesejada: '2026-06-10',
    orcamentoCliente: 680,
    status: 'aceita',
    criadoEm: '2026-05-20T09:00:00Z',
    atualizadoEm: '2026-05-22T14:30:00Z',
  },
  {
    id: 'prop007',
    clienteId: 'client001',
    prestadorId: 'prof003',
    descricao: 'Troca de disjuntores e revisão do quadro elétrico.',
    endereco: 'Rua das Flores, 123 — Jardim São Paulo',
    dataDesejada: '2026-05-05',
    orcamentoCliente: 350,
    status: 'aceita',
    criadoEm: '2026-04-25T10:30:00Z',
    atualizadoEm: '2026-04-28T16:00:00Z',
  },
  {
    id: 'prop008',
    clienteId: 'client001',
    prestadorId: 'prof002',
    descricao: 'Conserto de vazamento no banheiro social e troca de sifão.',
    endereco: 'Rua das Flores, 123 — Jardim São Paulo',
    dataDesejada: '2026-06-28',
    orcamentoCliente: 320,
    status: 'pendente',
    criadoEm: '2026-06-15T08:20:00Z',
  },
  {
    id: 'prop009',
    clienteId: 'client001',
    prestadorId: 'prof005',
    descricao: 'Montagem de estante planejada para o escritório.',
    endereco: 'Rua das Flores, 123 — Jardim São Paulo',
    dataDesejada: '2026-07-02',
    orcamentoCliente: 480,
    status: 'pendente',
    criadoEm: '2026-06-18T11:45:00Z',
  },
];
